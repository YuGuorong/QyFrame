 ...
 *------------------------------------------------------------------------------
 * 2010/04/07    linkai     PR00000672     UIÒÆÖ²
2010.04.15          yangrn      PR00000733          porting pray features and other featrues.
 * 2010/04/16    linkai     PR00000755     UIÒÆÖ²
 * 2010/04/21    linkai     PR00000793     porting table calllog PB SMS
 *------------------------------------------------------------------------------
...
{
                                    /* [English], [Description] */
    STR_GLOBAL_0 = 0,     /* "0", "Global String- 0" */
...
enum IMG_GLOBAL_LIST
{
    ...
    IMG_GLOBAL_L29,
    IMG_GLOBAL_L30,
#if 1//def __TL_APPENDED_LIST_NUMBER_ICON__    
    IMG_GLOBAL_L31,
    IMG_GLOBAL_L32,
    IMG_GLOBAL_L33,
    IMG_GLOBAL_L34,
    ...
    IMG_GLOBAL_L49,
    IMG_GLOBAL_L50,
#endif /* __TL_APPENDED_LIST_NUMBER_ICON__ */        
    IMG_GLOBAL_LEND,
    ...
    /* add new resource before here */
#if defined(__MMI_UI_STYLE_BLACKBERRY__)
    IMG_EXTRA_NUM_TYPE1_0,
    IMG_EXTRA_NUM_TYPE1_1,
    IMG_EXTRA_NUM_TYPE1_2,
    IMG_EXTRA_NUM_TYPE1_3,
    IMG_EXTRA_NUM_TYPE1_4,
    IMG_EXTRA_NUM_TYPE1_5,
    IMG_EXTRA_NUM_TYPE1_6,
    IMG_EXTRA_NUM_TYPE1_7,
    IMG_EXTRA_NUM_TYPE1_8,
    IMG_EXTRA_NUM_TYPE1_9,
    IMG_EXTRA_NUM_TYPE1_SIGN,
    IMG_EXTRA_NUM_TYPE1_BG,

    IMG_EXTRA_HIGHLIGHT_BG,//for stopwatch
#endif
    IMG_GLOBAL_END
};
